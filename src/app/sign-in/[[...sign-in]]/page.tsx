    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center p-6 bg-slate-50 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="font-heading font-bold text-2xl text-slate-900 mt-2">Welcome Back</h1>
          <p className="text-sm text-slate-500 mt-1">Take a deep breath. We are here to support you.</p>
        </div>
